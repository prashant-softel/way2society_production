										...
										if($newUserUrl <> "")
											{
												...
												<td>Please click below button to activate your way2society.com account and to check '.$sBillTypeText.'  Bill for ' .getDisplayFormatDate($InvoiceDate[0]['Inv_Date']).'</td>									
												...
												else
													{
														...
														// Change for Gundecha society
														$mailBody .= '<tr>
														<td>As agreed during the SGBM held on April 23, 2023 on the approval of Cultural Charges, we have deliberated and decided to charge it in a single supplementary bill to help us prepare for festivals and events for the financial year 2023-24. Since we are at the onset of major festivals, we would request you to make the payment at the earliest.<p>We are raising a single Supplementary bill of Rs 5000 and request you to make the payment on or before 15th September, 2023.</p><ul><li>This fund will be used for conducting events and festivals, sports & recreational activities in the Society</li></ul></td>
														</tr><tr><td><br/></td></tr>';
													//$mailBody .= '<tr>

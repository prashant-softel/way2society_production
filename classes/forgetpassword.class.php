...
/*			$SMTP_Username = "cs@way2society.com";
			$SMTP_Password = "cs1234!";
			$SMTP_endpoint = "103.50.162.146";   */

			//$sender = "no-reply@way2society.com";
			//$senderName = "Way2Society.com";
			$sender_noreply = "no-reply@way2society.com";
			$senderName_W2S = "Way2Society.com";

			//$transport = Swift_SmtpTransport::newInstance(SMTP_endpoint, SMTP_Port, SMTP_Security)
			//$transport = Swift_SmtpTransport::newInstance($SMTP_endpoint, $SMTP_Port, $SMTP_Security)

/*			$transport = Swift_SmtpTransport::newInstance($SMTP_endpoint, 587)  */
			...
			$message->setTo(array(
			 ...
			 $message->setReplyTo(array(
					   $sender_noreply => $senderName_W2S
					)); 
			$message->setSubject($mailSubject);
			$message->setBody($mailBody);
			$message->setFrom($sender_noreply, $senderName_W2S);

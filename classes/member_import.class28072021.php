...
class member_import 
{
	public $allColumns = array('BCode', 'WCode', 'FCode', 'Owner','ExtnLedgerName','Occupation', 
	...
	{
		$this->errorfile_name = 'member_import_errorlog_'.date("d.m.Y").'_'.rand().'.html';
	...
	{
		$this->errorfile_name = '../process/import_log/update_members_errorlog_'.date("d.m.Y").'_'.rand().'.html';
		$this->errorLog = $this->errorfile_name;
		$errorfile = fopen($this->errorfile_name, "a");

...
<head>
	...
	{
		var rId = "<?php if(isset($_REQUEST['rId'])){echo $_REQUEST['rId'];}else { echo "";}?>";
		var action = "<?php if(isset($_REQUEST['action'])){echo $_REQUEST['action'];}else { echo "";}?>";
		//alert(action);
		$.ajax
		({
			...
			type : "POST",
			data: {"method": "updateRenovationStatus", "renovationId":rId, "type":action},
	...
	$( document ).ready(function()
	{
		...
		//alert (tempType);
		//alert (aId);
		var role = "<?php echo $verificationAccess;?>";//Verification Access Flag
		var role2 = "<?php echo $approvalAccess;?>";//Approval Access Flag
		...
		if(tempType == "<?php echo $_SESSION['RENOVATION_DOC_ID']?>" && rId != "")
		{
			...
			//document.getElementById("doc_temp_3").style.display = "table-row";
			$.ajax
			({
				url : "ajax/ajaxdocument_maker.ajax.php",
				type : "POST",
				data: {"method": "fetch_final_template", "renovationId":rId},
				success: function(data1)
				{
					//console.log(data1);
					//alert ("in success");
					//alert (data1);
					CKEDITOR.instances['events_desc'].setData(data1);
					
					//document.getElementById("renovationDiv").innerHTML = data1;
				}
			});
			$.ajax
				({
		...
		if(tempType == "<?php echo $_SESSION['ADDRESS_PROOF_ID']?>" && aId != "")
		{
			...
			({
				url : "ajax/ajaxdocument_maker.ajax.php",
				type : "POST",
				data: {"method": "fetch_address_proof_noc", "serviceRequestId":aId},
				success: function(data1)
				{
	...
	<script type="text/javascript">
		...
		function validate()
		{
			var template = document.getElementById("temp_type").value;
			if(template == "53")
			{
				var startDate = document.getElementById('startDate').value;
				if(startDate == "")
...
<form name="templates" id="templates" method="POST" action="process/document_maker.process.php" enctype="multipart/form-data" onSubmit="return validate(); ">
	...
	<table width="100%">
        ...
        <button type="button" class="btn btn-primary" onClick="goToRenovationReport()" style="float:right;margin-right:5%;display:none" id="btnBackReport" value="btnBackReport">Back to Renovation Report</button>
    	<tr id="main_tr_1"> 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
							<td colspan="4"><center><input type="submit" id="generate_for_renovation" name="generate_for_renovation" value="Generate" class="btn btn-primary"></center></td>
						</tr>
                        <tr>
							<td><br></td>
						</tr>
                                ...
                                <table width="70%">
                                    ...
                                    <tr style="margin-left:10%">
                                 		<td colspan="2" style="margin-left:10%">
											...
											<table width="70%">
                                            	<tr>
													<td><?php echo $star;?>&nbsp;<b>Staying Since &nbsp;:&nbsp;</b></td>
                            						<td width="73%" style="text-align:left;padding-top:1%">
                                						<input type="text" name="stayingSince" id="stayingSince" class="basics_Dob" style="width:30%"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $star;?>&nbsp;<b>Purpose&nbsp;:&nbsp;</b>
                                            			<select id="purpose" name = "purpose" style="width:35%">
                                                			...
                                                			<option value="2">Passport NOC</option>
                                               	 			<option value="2">Address Proof NOC</option>
                                            			</select>
                                      				</td> 
                                        		</tr>
                                    			<tr>
                                 					<td style="text-align:left;vertical-align:center;padding-top:1%;padding-left:3.5%">&nbsp;<b>Owner Address&nbsp;:&nbsp;</b>      			
                                        			</td>
                                        			<td style="text-align:left;vertical-align:center;padding-top:1%;"><?php echo $memberAddress;?></td> 
                              					</tr>
                                                <tr style="padding-top:1%">
                                 					<td style="text-align:left;vertical-align:center;padding-top:1%;padding-left:3.5%">&nbsp;<b>Note&nbsp;:&nbsp;</b>      			
                                        			</td>
                                        			<td style="text-align:left;vertical-align:center;padding-top:1%;"><textarea id="addressProof_note" name="addressProof_note" cols="60" rows="4"></textarea></td> 
                              					</tr>
                                    		</table>
                                            </center>
                                    	</td>
                                    ...
                                    <tr>
										<td colspan="4"><center><input type="submit" id="generate_for_addressProof" name="generate_for_addressProof" value="Generate" class="btn btn-primary"></center></td>
									</tr>
                        			<tr>
										<td><br></td>
									</tr>

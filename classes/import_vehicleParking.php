...
<input type="hidden" name="sid" value="<?php echo $_SESSION['society_id'];?>">
	...
	<span style="color:red;">*Date should be in DD-MM-YYYY format</span><br>
    <span>Vehicle Data Sample File : <a href="samplefile/societyVehicle_Import.csv" download>Click here to Download</a> </span>
</center>
</div>
</div>
    </form>

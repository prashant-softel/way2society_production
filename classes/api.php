  ...
  if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS') {
  	...
  	if (isset($postdata)) 
	{
		...
		else if($method == "submitRenovationDetails")
		{
			...
			$result = $obj_templates->addRenovationDetails2($societyId,$unitId,$startDate,$endDate,$workDetails,$workType,$location,$contractorName,$contractorContact,$contractorAddress,$maxLabourer,$labourerName,$srTitle,$srPriority,$srCategory,$loginId);
			$response = array();
			if($result != "")
			{
				$response['success'] = "1";

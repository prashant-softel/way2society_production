				...
				else
				{
					...
					if($datas[$i]['LedgerID'] > 0)
					{
						...
						if(!isset($_GET['q']) || (isset($_GET['q']) && $_GET['q'] == 2))
						{
							...
							$tree .= '<a href = "'.$Url.'">'.$datas[$i]['name'].' target="_blank"</a></div><div style="border:none;width:12.5%;text-align:right;float:left;" class="icon-minus-sign"><a href = "'.$Url.'" target="_blank">'.number_format($datas[$i]['OpeningBalanceCredit'],2).'</a></div>

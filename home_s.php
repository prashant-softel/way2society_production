...
<div class="row" style="margin:5px !important" >
	<div class="col-md-3" style="width:33.3%">
		<select name="UnitID" class="js-example-basic-multiple form-control" id="UnitID" style="width:258px;" onchange="View_Member()" >

			<?php
				//value of outsider is sent here to fetch different value in dropdown   
				echo $combo_state = $obj_AdminPanel->FetchUnitName($outsider = 0); ?> 
       </select>
	</div>
	<div class="col-md-3" style="width:33.3%">
		<select name="LedgerID" class="js-example-basic-multiple form-control" id="LedgerID" style="width:258px;" onchange="View_Ledger()" >

			<?php
				//value of outsider is sent here to fetch different value in dropdown   
				echo $combo_ledger= $obj_AdminPanel->FetchLedger(); ?> 
       </select>
	</div>
...
<script>
   function View_Member(){
      // bind change event to select
          var view_member_url = $('#UnitID').val(); // get selected value
          if (view_member_url) { // require a URL
              window.open(view_member_url,'_blank' );
          }
          return false;
     } 
    ...
    function View_Ledger(){
      // bind change event to select
          var view_ledger_url = $('#LedgerID').val(); // get selected value
          if (view_ledger_url) { // require a URL
              window.open(view_ledger_url,'_blank' );
          }
          return false;
     } 

...
<head>
<title>W2S - Import Member details</title>
</head>
...
<input type="hidden" name="sid" value="<?php echo $_SESSION['society_id'];?>">
    ...
    <!--<span>Members Data Sample File : --><a href="samplefile/Import_Member.csv" class="btn btn-primary" style="width:200px; height:30px; font-family:'Times New Roman', Times, serif; font-style:normal; color: #fff; background-color: #337ab7; border-color: #2e6da4;" download> Download Sample </a> <br/><br/>

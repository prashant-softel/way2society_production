...
include_once("includes/header_empty.php");
	...
	if(isset($_REQUEST['reg']))
	{
		...
		if($bCheckEmailIdAlreadyExists == true)
		{
			...
			?>
            <script>
				 window.location.href = "https://way2society.com/login.php?u=<?php echo $encryptedEmail ?>&mCode=<?php echo $_REQUEST['c'] ?>&url=<?php echo $url?>";
			</script>
	<?php  }
            else
            {
             ...
             ?>  
              <script>
				window.location.href = "https://way2society.com/login.php?u=<?php echo $encryptedEmail ?>&mCode=<?php echo $_REQUEST['c'] ?>";
			</script>
                    ...
                    <tr>
                        ...
                        <p style="float: none;clear: both;vertical-align: middle; border: 1px solid rgb(204, 204, 204)">
                            ...
                            <label style="display:inline; float:none" for="agree">
                              I agree with the <a href="https://way2society.com/?page_id=5640" 
  target="popup" 
...
{*/
	...
	if($URL <> "")
	{
		...
		<script>window.location.href = "<?php echo $initializeURL; ?>";</script><?php
	}

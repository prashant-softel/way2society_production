...
<head>
	...
	<script type="text/javascript" src="js/jsmem_bike_parking.js"></script>
...
<div class="panel panel-info" id="panel" style="display:none;margin-top:6%;margin-left:3.5%; border:none;width:70%">
        <div class="panel-heading" id="pageheader">Member Bike Details</div>
...
<center>
<form name="mem_bike_parking" id="mem_bike_parking" method="post" action="process/mem_bike_parking.process.php" onSubmit="return val();">
    ...
    <table align='center'>
		...
		<tr>
			...
			<td>
                ...
                {
				$owner_name = $obj_mem_bike_parking->owner_name($_REQUEST['idd']);
				?>    
        ...
        <tr>
            ...
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="bike_reg_no" id="bike_reg_no" /></td>
		</tr>
        ...
        <tr>
			...
			<td>Bike Owner</td>
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="bike_owner" id="bike_owner" /></td>
		</tr>
		...
		<tr>
			...
			<td>Bike Model</td>
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="bike_model" id="bike_model" /></td>
		</tr>
        ...
        <tr>
			...
			<td>Bike Make</td>
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="bike_make" id="bike_make" /></td>
		</tr>
        ...
        <tr>
			...
			<td>Bike Colour</td>
            <td>&nbsp; : &nbsp;</td>
			<td><input type="text" name="bike_color" id="bike_color" /></td>
		</tr>
...
<?php
echo "<br>";
$str1 = $obj_mem_bike_parking->pgnation();
echo "<br>";
echo $str = $obj_mem_bike_parking->display1($str1);
echo "<br>";
$str1 = $obj_mem_bike_parking->pgnation();
echo "<br>";
?>

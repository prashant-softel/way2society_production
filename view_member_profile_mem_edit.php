...
<?php
include_once "classes/view_member_profile_mem_edit.class.php" ;
$obj_view_member_profile_mem_edit = new view_member_profile_mem_edit($m_dbConn);
//print_r($_SESSION);
if(!isset($_GET['id']) )
{
$sql="select member_id from `member_main` where unit='".$_SESSION['unit_id']."' ";
$res=$m_dbConn->select($sql);
$_GET['id']=$res[0]['member_id'];	
	
}
$show_member_main 		 = $obj_view_member_profile_mem_edit->show_member_main();
$show_mem_spouse_details = $obj_view_member_profile_mem_edit->show_mem_spouse_details();
//print_r($show_mem_spouse_details);
$show_mem_child_details  = $obj_view_member_profile_mem_edit->show_mem_child_details();
$show_mem_other_family   = $obj_view_member_profile_mem_edit->show_mem_other_family();
$show_mem_car_parking    = $obj_view_member_profile_mem_edit->show_mem_car_parking();
$show_mem_bike_parking   = $obj_view_member_profile_mem_edit->show_mem_bike_parking();
...
<br>
<!--<center><a href="list_member.php?scm" style="color:#00F; text-decoration:none;"><b>Back to list</b></a></center>-->
<br>
...
<tr align="left">
	<td><b><?php echo $star;?>Owner Name</b></td>
    <td>:</td>
    <td align="left">
...
<tr align="left">
	<td><b><?php echo $star;?>Residence Number</b></td>
    <td>:</td>
    <td>
    ...
    <td><b><?php echo $star;?>Mobile No.</b></td>
    <td>:</td>
    <td>
...
<tr align="left">
    ...
    <select name="desg" id="desg" style="width:142px;">
		<?php echo $combo_desg = $obj_view_member_profile_mem_edit->combobox11("select desg_id,desg from desg where status='Y' order by desg" , $show_member_main[0]['desg_id']); ?>
    </select>
    </td>
</tr>

<tr align="left">
	<td><b><?php echo $star;?>Email ID</b></td>
    <td>:</td>
    <td>
...
<tr align="left">
    ...
    <select name="bg" id="bg" style="width:142px;">
		<?php echo $combo_desg = $obj_view_member_profile_mem_edit->combobox11("select bg_id,`bg` from bg where status='Y'" , $show_member_main[0]['bg_id']); ?>
    </select>
    </td>
	...
	<td colspan="6">
        ...
        <tr height="25" bgcolor="#BDD8F4">
            ...
            <select name="spouse_desg" id="spouse_desg" style="width:112px;">
				<?php echo $combo_spouse_desg=$obj_view_member_profile_mem_edit->combobox11("select desg_id,desg from desg where status='Y'" , $show_mem_spouse_details[$k]['spouse_desg']); ?>
            </select>
            </td>
            <td align="center">
            ...
            <select name="spouse_bg" id="spouse_bg" style="width:112px;">
				<?php echo $combo_desg = $obj_view_member_profile_mem_edit->combobox11("select bg_id,`bg` from bg where status='Y'" , $show_mem_spouse_details[$k]['bg_id']); ?>
            </select>
            </td>
        </tr>
        <?php
...
<tr>
	<td colspan="6">
		...
		<?php echo $combo_spouse_desg_c=$obj_view_member_profile_mem_edit->combobox11("select desg_id,desg from desg where status='Y'" , $show_mem_child_details[$k1]['desg_id']); ?>
            </select>
            </td>
            <td align="center">
			...
			<?php echo $combo_desg_child = $obj_view_member_profile_mem_edit->combobox11("select bg_id,`bg` from bg where status='Y'" , $show_mem_child_details[$k1]['bg_id']); ?>
            </select>
            </td>
        </tr>
        <?php
...
<tr>
	<td colspan="6">
		...
		<?php echo $combo_spouse_desg_o=$obj_view_member_profile_mem_edit->combobox11("select desg_id,desg from desg where status='Y'" , $show_mem_other_family[$k2]['desg_id']); ?>
            </select>
            </td>
            <td align="center">
			...
			<?php echo $combo_desg_child = $obj_view_member_profile_mem_edit->combobox11("select bg_id,`bg` from bg where status='Y'" , $show_mem_other_family[$k2]['bg_id']); ?>
            </select>
            </td>
        </tr>
        <?php
...
<br>
<center>
	 <input type="submit" name="update" id="insert" value="Update" style="width:100px; height:30px; color:#FFF;" class="btn btn-primary" >
</center>

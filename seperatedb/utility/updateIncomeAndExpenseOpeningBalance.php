...
<script>
	function updateOpeningBalance()
	{
		...
		if(dbNo != '')
		{
			...
			$.ajax({
				url : "script/UpdateIncomeAndExpenseOpeningBalance.script.php",
				type : "POST",
				data: { "dbNo": dbNo, 
					},
...
<body>
	...
	<p>NOTE : Select DB to update income and expense opening balance.</p>
	<b>DB Name : </b>hostmjbt_society&nbsp;<input type="text" name="start" id="start" />
    <br><br>
    <input type="button" value="Update" onclick="updateOpeningBalance();" />
	<br /><br />

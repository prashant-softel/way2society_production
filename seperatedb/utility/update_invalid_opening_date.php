...
<script>
	function findInvalidOpeningDate()
	{
		...
		if(startNo != '' && endNo != '')
		{
			...
			$.ajax({
				url : "script/findInvalidOpeningDateAndUpdate.script.php",
				type : "POST",
...
<body>
	<h3>Select the Database to Find Invalid Opening Date and Update</h3>
	...
	<br /><br />
    <input type="button" value="Find Invalid TDS" onclick="findInvalidOpeningDate();" />
	<br /><br />

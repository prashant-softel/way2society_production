...
<script>
	function backupDB()
	{
		...
		var bIsBackUpRootDB = 0;
		
		if($("#bk_root").is(':checked'))
		{
			bIsBackUpRootDB = 1;
		}
		...
		{
			document.getElementById('msg').innerHTML = 'Message Log : <br />DB Restore in process. Please Wait...';
			$.ajax({
				url : "script/restore.script.php",
				type : "POST",
				data: { "start": startNo, 
						"end": endNo,"backuproot": bIsBackUpRootDB},
...
<body>
	<h3>Select the Database to Restore</h3>
	<p>NOTE : Select same Start and End name if only single DB is to be backed up.</p>
	...
	<br /><br />
    <b>Backup Root Databse(hostmjbt_societydb) &nbsp;&nbsp;: </b>&nbsp;<input type="checkbox" name="bk_root" id="bk_root" value="1" />
	<br /><br />

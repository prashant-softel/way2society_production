...
<script>
	function backupDB()
	{
		...
		{
			document.getElementById('msg').innerHTML = 'Message Log : <br />DB backup in process. Please Wait...';
			$.ajax({
				url : "script/backupdb.script.php",
				type : "POST",
				data: { "start": startNo, 
...
<body>
	<h3>Select the Database to Backup</h3>

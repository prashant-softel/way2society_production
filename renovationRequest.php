...
<head>
<title>W2S - Renovation Request</title>
</head>
...
$approval = $objRenovationRequest->getApprovalLevel();
...
<div class="panel panel-info" style="margin-top:4%;margin-left:1%; width:100%">
    ...
    <div class="panel-body">                        
        <div class="table-responsive">
      	...
      	<ul class="nav nav-tabs" role="tablist">
             <li <?php echo (isset($_REQUEST['type']) && $_REQUEST['type'] == "pending") ? 'class="active"' : ""; ?>>
            	<a href="#profile" role="tab" data-toggle="tab" onClick="window.location.href='renovationRequest.php?type=pending'"><b>Pending Request</b></a>
    		</li>
            <li <?php echo (isset($_REQUEST['type']) && $_REQUEST['type'] == "verified") ? 'class="active"' : ""; ?>> 
            	<a href="#home" role="tab" data-toggle="tab" onClick="window.location.href='renovationRequest.php?type=verified'"><b>Verified Request</b></a>
    		</li>
            <li <?php echo (isset($_REQUEST['type']) && $_REQUEST['type'] == "approved") ? 'class="active"' : ""; ?>>
            	<a href="#profile" role="tab" data-toggle="tab" onClick="window.location.href='renovationRequest.php?type=approved'"><b>Completed Request</b></a>
    		</li>
        </ul>
        <?php
			$result = $objRenovationRequest->getRenovationRequest($_REQUEST['type']); 
			//var_dump($result);
		?>
		<br/>
       ...
       <div id='showTable' style="font-weight:lighter;" >
            ...
            <div style="display:none;" id="heading" ><center><h2><font>Pending Renovation Requests</font></h2></center></div>
            </center>
    		<table style="text-align:left; width:100%;margin-top:2%" class="table table-bordered table-hover table-striped" cellpadding="50">
        		<thead>
            		<tr style="border:1px solid #ddd;">
                    	...
                    	<th style="border:1px solid #ddd; text-align:center;">Work Type</th>
                    	<th style="border:1px solid #ddd; text-align:center;">Verified</th>  
                		<?php 
						if($approval == 2)
						{
						?>
                    		<th style="border:1px solid #ddd; text-align:center;">Approved By<br />1st Level</th> 
                 			<th style="border:1px solid #ddd; text-align:center;">Approved By<br />2nd Level</th>
						<?php 
                   		}
						if($approval == 1)
						{
				...
				if(sizeof($result) > 0)
				{
                    ...
                    <tr style="border:1px solid #ddd;vertical-align:central">
                        ...
                        <td style="border:1px solid #ddd; text-align:center;"><?php echo $result[$i]['primary_owner_name']?></td>
                        <td style="border:1px solid #ddd; text-align:center;"><?php echo $result[$i]['priority']?></td>
                        <td style="border:1px solid #ddd; text-align:center;"><?php echo $result[$i]['type_of_work']?></td>

...
<head>
<title>W2S - Import Service Provider</title>
</head>
...
<form name="display_data" action="display_data.php" method="post" enctype="multipart/form-data" target="_blank">
...
<input type="hidden" name="sid" value="<?php echo $_SESSION['society_id'];?>">
    ...
    <!-- <span>Service Provider Sample File : --><a href="samplefile/Service_Provider.csv" class="btn btn-primary" style="width:200px; height:30px; font-family:'Times New Roman', Times, serif; font-style:normal; color: #fff; background-color: #337ab7; border-color: #2e6da4;" download>Download Sample</a> <br/><br/>

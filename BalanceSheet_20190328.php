...
<tr>
    ...
    <?php  
       ...
       echo ('<div class="tree well">'.$objLIABILITY->generateBalanceSheet($LIABILITYData,0,1));
        echo '<ul><li><label><span style="border:none;width:270px;">Profit & Loss A/c</span><span style="border:none;width:50px;text-align:right;"><a href = "IncomeStmt.php">'.number_format($ProfitnLoss,2).'</a></span></label><ul ><li style="display:none;"><label><span style="border:none;width:270px;font-weight:normal;" class="icon-minus-sign">Opening Balance</span><span style="border:none;width:50px;text-align:right;font-weight:normal;" class="icon-minus-sign">'.number_format($LastYearBalance,2).'</span></label></li></ul><ul ><li style="display:none;"><label><span style="border:none;width:270px;font-weight:normal;">Current Year</span><span style="border:none;width:50px;text-align:right;font-weight:normal;" class="icon-minus-sign">'.number_format($CurrentYearBalance,2).'</span></label></li></ul></li></ul>';
		echo '</div>';

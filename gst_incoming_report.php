        ...
        <table  style="width:100%;font-size:14px;">
			   ...
			   $tmpUnit = $GST_Incoming_Reoprt[0]['UnitID'];
					...
					for($iCount=0;$iCount<sizeof($GST_Incoming_Reoprt);$iCount++)
				           ...
				           //$taxable_amt=$GST_Incoming_Reoprt[$iCount]['InvPayable'];
						   //$taxable_amt=($GST_Incoming_Reoprt[$iCount]['SGST']/0.09)+($GST_Incoming_Reoprt[$iCount]['CGST']/0.09); 
						   $taxable_amt=($GST_Incoming_Reoprt[$iCount]['SGST']/0.09);
						  // echo "<BR> UNit NO =>".$unitNumber."SGST =>".$GST_Incoming_Reoprt[$iCount]['SGST']."TAXA=>".$taxable_amt;

...
<title>W2S - Share Certificate</title>
</head>
...
<?php 
	...
	{
		$Head = "Import Share Certificate ";
		$csv_file = "sharecertificate.csv";
		$text_file = "sharecertificate.txt";
		$flag = 14;
		$CreditNoteSet = 0;
...
<!-- <div style="color:#FF0000">* File Name Should be "<?php echo $csv_file; ?>/"<?php echo $text_file; ?>(comma delimited file)"</div> -->

<!--<span>Please Download this template file and fill the data in appropriate columns.--><a href="samplefile/import_share_certificate.csv" class="btn btn-primary" style="width:200px; height:30px; font-family:'Times New Roman', Times, serif; font-style:normal; color: #fff; background-color: #337ab7; border-color: #2e6da4;" download> Download Sample </a> <br/>
<!-- 
<span><a href="samplefile/Import_lein.csv" download>Click here to Download</a> Sample</span> -->

<!-- Download Sample Invoice File-->

</form>
<br>
<!-- <form id="downloadform" name="downloadform" action="process/download_lein.process.php" method="post" style:"padding-bottom:50px;">
<input type="hidden" name="NoteType" value="<?php //echo $NoteType;?>">
<input type="submit" id="Download" name="Download" value="Download Sample" class="btn btn-primary" style="width:200px; height:30px; font-family:'Times New Roman', Times, serif; font-style:normal; color: #fff; background-color: #337ab7; border-color: #2e6da4;"/>
<br>&nbsp; &nbsp;</form>
</center>

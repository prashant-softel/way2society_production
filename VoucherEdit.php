...
<div id="middle">
    ...
    <div class="panel-heading" id="pageheader">Update <?php echo $Head;?></div>	

<center>
<br>

<form name="editvoucher" id="editvoucher" method="post"  action="process/createvoucher.process.php" onSubmit="return doFormSubmit(minStartDate,maxEndDate);" >
<table  id="table_details" width="100%" style="text-align:center;" >
    ...
    <tbody>
	    ...
	    <input type="hidden" name="OnPageLoadTimeVoucherNumber" id="OnPageLoadTimeVoucherNumber" value="" />
            ...
            <input type="hidden" name="IsCallUpdtCnt" id="IsCallUpdtCnt" value="0" />
		  ...
		  /* echo "<tr align='center'>";
                        ...
                        echo "<td colspan='5' style='font-size:14px;' align='left'>Voucher Date: <input type='text' name='voucher_date' id='voucher_date'  class='basics' size='10'   style='width:100px;' value=".$Data[0]['Date']."></td>";
           echo "</tr>";*/
		    ...
		    echo "<tr align='center'>
				  ...
				  {
					  echo "<tr style='font-size:14px;'><td colspan='4' align = 'center' style=' padding-bottom: 15px;'>".$DateString.": <input type='text' name='voucher_date' id='voucher_date'  class='basics' size='10'   style='width:100px;' value=".$Data[0]['Date']."  placeholder='dd-mm-yyyy'></td></tr>";
				  }
                 echo "<tr>";
				 if(!isset($_REQUEST['receipt']))
				  {
					   echo "<td style='font-size:14px; width:".$width."%;' align='left'>".$DateString.": <input type='text' name='voucher_date' id='voucher_date'  class='basics' size='10'   style='width:100px;' value=".$Data[0]['Date']."  placeholder='dd-mm-yyyy'>";
				  }
				  else
				  {
					...
					if(isset($_REQUEST['receipt']) && $_REQUEST['receipt'] == 1)
					{
						echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cheque Date : <input type='text' name='cheque_date' id='cheque_date'  class='basics' size='10'   style='width:100px;' value=".getDisplayFormatDate($receiptData[0]['ChequeDate'])."  placeholder='dd-mm-yyyy'>";
				...
				echo "	<input type='hidden' id='InvoiceStatusID' name='InvoiceStatusID' value=".$Data[0]['InvoiceStatusID'].">
					...
					echo "<td style='font-size:14px; width:25%;' align='left'>Voucher Number: <input type='text' name='VoucherNumber' id='VoucherNumber' size='7'   style='width:100px;'  value=".$Data[0]['ExternalCounter']." required /></td>";		  
					 if(isset($_REQUEST['bankid']))
					  {
						  if(isset($_REQUEST['payment']) && $_REQUEST['payment'] == 1)
						  {
...
<table id="table_details2" width="100%" style="text-align:center;">
    <tbody>
       ...
       <tr align="center">
        ...
        <tr align="center"><td colspan="5" style="font-size:12px;"><input type="submit" name="submit" id="submit" value="Update" style="width:120px; height:30px; background-color:lightgray;" ></td>
        </tr>

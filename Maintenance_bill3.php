...
<body>
	...
	<?php }?>
       <td> <div id="bill_header" style="text-align:center;">
            ...
            <?php if($bApplyServiceTax == 1 && $objFetchData->objSocietyDetails->sSocietyGSTINNo <> '')
			{
				?>
           ...
           <table style="width:100%;font-size:14px;">
          		<tr>
                	<!--<td colspan="3" rowspan="<?php echo $IsSupplementaryBill ? "2" : "7" ?>" style="width:<?php echo $IsSupplementaryBill ? "60%" : "50%" ?>">E.& O.E.</td>-->
					 ...
					 <td colspan="3" rowspan="<?php echo ($bApplyServiceTax == 1 || $BillTax > 0 || $CGST >0 || $SGST >  0 ) ? $value : 8 ?>" style="width:50%;padding-left:3px;font-size: 12px; border-top: 1px solid black;">

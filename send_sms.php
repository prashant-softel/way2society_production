<?php
	...
	//include_once('way2society.com/classes/include/dbop.class.php');
	//$dbConn = new dbop();
	//include('config_script.php');
	//include_once('way2society.com/classes/utility.class.php');
	echo "b";
	//include_once('way2society.com/classes/email_format.class.php');
	echo "d";

      ...
      <script type="text/javascript">
		$( document ).ready(function()
		{
			...
			({
				...
				type : "POST",
				datatype: "JSON",
				data : {"method":"viewMeeting","mId":mId, "sName":sName},
		...
		{
			var divElements = document.getElementById('meetingDetails').innerHTML;
    ...
    <center>
      <form id="viewMeeting" name="viewMeeting" action="#" method="post" enctype="multipart/form-data">
        ...
        <div class="panel panel-info" id="panel" style="display:none">
              ...
              <input type="hidden" id="sName" name="sName" value="<?php echo $socName; ?>"/>
        <div>
        	<table width="55%">
            	<tr>
                	<td id="meetingDetails" name="meetingDetails">
                    </td>
                </tr>
            </table>
            <br>

    ...
    <div style="border:1px solid black;">
        ...
        <div id="bill_charges">
           ...
           <table style="width:100%;font-size:14px;">
				...
				if(isset($_REQUEST['edt'])){?>
                <tr> 
					<!-- add late fee for ROYAL COURT society  -->
					<td style="width:14%;border:1px solid black;text-align:right;font-size:<?php echo $BillFont?>px;"><?php echo (($_SESSION['society_id'] == 417)? 'Late Fees' : 'Interest')?>&nbsp;</td>
                    <td id="sub_total" style="text-align:right;width:16%;border:1px solid black;">
						<?php if($_SESSION['role']==ROLE_SUPER_ADMIN){ ?>
               ...
               <?php if(isset($_REQUEST['edt'])){?>
				<tr>
                	<td style="width:20%;border:1px solid black;font-size:<?php echo $BillFont?>px;" colspan="2"><?php echo (($_SESSION['society_id'] == 417)? 'Late Fees on Arrears' : 'Interest on Arrears')?></td>
				...
				<?php
					?>
					<tr>
		            	<td style="width:20%;border:1px solid black;padding-left:3px;font-size:<?php echo $BillFont?>px;" colspan="2"> <?php echo (($_SESSION['society_id'] == 417)? 'Late Fees on Arrears' : 'Interest on Arrears')?> <?php echo (($bApplyServiceTax && $bApplyGSTOnInterest) ? "(C)" : "");  ?></td>

...
?>
 ...
 <div class="panel-body" <?php if($bIsHide == true){ echo 'style="display:none;"';}else{echo 'style="width:50%;height:40px;margin-top:0px;margin-left:40px;;margin-left:4vw;width:50.00vw;height:4.vw" ';} ?>>
                            ...
                            <ul class="nav nav-pills" style="height:20px;height:2vw">
                                ...
                                <span style="float:right;margin-top:15px;margin-right: -20%;"><a style="font-size:15px;cursor:pointer;text-decoration:none" title="" href="https://way2society.com/Uploaded_Documents/Provisional_list_of_voters_31012021.pdf" target="_blank"><b>Provisional list of voters as of 31.01.2021 </b><sup class="blinking" style="color:red; padding-left:5px;"><b>News</b></sup></a></span>
                            	<?php }?>
                            </ul>

...
<?php } ?>
	...
	<tr style="background-color:#bce8f1;font-size:14px;" height="25">
       ...
       <!-- <th style="width:40%;">Billing Information</th></tr>-->
        ...
        <tr >
         ...
         <tr >
        	<td valign="left"><span style="margin-left: 28px;"><?php //echo $star;?></span><span  style="margin-left: 2%;">Society Name of TDS Challan</span><span  style="margin-left: 0px;">&nbsp; : &nbsp;</span>
			<span  style="margin-left: 4%;"><div style=" width: 50%;float: right;margin-right: 4%;"><input type="text" name="tds_society_name" id="tds_society_name"  class="field_input" value="<?php echo $_REQUEST['tds_society_name'];?>"/></div></span></td>
		</tr>
        <tr >
	...
	<tr>
        ...
        <tr >
         ...
         <tr >
        	<td valign="left"><span style="margin-left: 4%;"><?php //echo $star;?>&nbsp;</span><span  style="margin-left: 3%;">Show Email & postal code bill</span><span  style="margin-left: 2px;">&nbsp; : &nbsp;</span>
			<span  style="margin-left: 4%;"><input type="checkbox" name="show_in_email_bill_header" id="show_in_email_bill_header"   value="1"></span></td>
		</tr>
        <tr >
		...
		<span  style="margin-left: 4%;">
			<!--<input type="checkbox" name="show_logo" id="show_logo" value="1" style="margin:0">
  			<label for="show_logo">Show Logo on bill</label><br>-->
			<input type="file" name="photo" id="photo" size="18" class="field_input" style="width:210px;float: right;  margin-right: 13%;margin-top: -1%;"/><span style="color: blue;" id="logoImg" value=""></span></span></td></tr>
      	<tr><td id="logobtn"><span style="margin-left: 46%;">&nbsp;</span><span style=""><input type="button" value="Upload" onclick="UploadLogo()"> </span></td></tr>
        <tr><td id="logomsg"><span style="margin-left: 46%;">&nbsp;</span><span style="color: red;">Note : Upload Only png image (210x181) </span></td></tr>
	...
	<tr><td><br></td></tr>
        ...
        <tr><td class="err-msg"></td></tr>
       
        <tr>
               
        	<td valign="left"><span style="margin-left: 4%;">&nbsp;</span><span  style="margin-left: 3%;">Society QR Code</span><span  style="margin-left: 66px;">&nbsp; : &nbsp;</span>
		<span  style="margin-left: 4%;">
        <!--<input type="checkbox" name="show_QR_code" id="show_QR_code" value="1" style="margin:0">
  			<label for="show_QR_code">Show QR Code on Maintenance bill</label><br>-->
            <input type="file" name="qrcode" id="qrcode" size="18" class="field_input" style="width:210px;float: right;  margin-right: 13%;margin-top: -1%;"/><span style="color: blue;" id="qrcodeImg" value=""></span></span></td>
		</tr>
        <tr><td id="qrcodebtn"><span style="margin-left: 46%;">&nbsp;</span><span style=""><input type="button" value="Upload" onclick="UploadQRCode()"> </span></td></tr>
        <tr><td id="qrcodemsg"><span style="margin-left: 46%;">&nbsp;</span><span style="color: red;">Note : Upload Only png image (210x210)</span></td></tr>
         
         <tr>
        	<td valign="left"><span style="margin-left: 4%;">&nbsp;</span><span  style="margin-left: 3%;">Show Logo on bill</span><span  style="margin-left: 64px;">&nbsp; : &nbsp;</span>
		<span  style="margin-left: 4%;"><input type="checkbox" name="show_logo" id="show_logo" value="1" style="margin:0"></span></td>
		</tr>
         <tr>
	...
	<tr><td><br></td></tr>
        ...
        <tr>
        	<td valign="left"><span style="margin-left:4%;"><?php //echo $star;?> &nbsp;</span><span  style="margin-left: 3%;"> </span><span style="margin-left:163px;">&nbsp;  &nbsp;</span>
			 <span style="margin-left:4%;"><label><input type="checkbox" name="show_virtual" id="virtual" value="1" />&nbsp;&nbsp;Virtual A/C No</label></span>
             <span style="margin-left:4%;"><?php //echo $star;?>&nbsp;</span><span  style="margin-left: 2%;">  </span><span >&nbsp;  &nbsp;</span>
             <span style="margin-left:-1%;"><label><input type="checkbox" name="show_intercom" id="intercom" value="1" />&nbsp;&nbsp;Intercom No</label></span>
             </td>
		</tr>
		...
		<tr>
        	<td valign="left">
        		<span style="margin-left:4%;">&nbsp;</span>
        		<span style="margin-left: 3%;">Reco date same voucher date</span>
        		<span style="margin-left:0px;"> : </span>
				<span style="margin-left:5%;">
					<input type="checkbox" name="reco_date_same_as_voucher" id="reco_date_same_as_voucher" value="1" />&nbsp;&nbsp;
				</span>
			</td>
		</tr>
        <tr><td><br></td></tr>
        ...
        <tr>
         ...
         <tr>
        	<td valign="left"><span style="margin-left:4%;"><?php //echo $star;?>&nbsp;</span><span  style="margin-left: 3%;">Bill Template</span><span style="margin-left:94px;">&nbsp; : &nbsp;</span>
           <span style="margin-left:4%;"> 
           	<select name="bill_temp" id="bill_temp" class="field_select">
            		<OPTION VALUE="<?php echo ORIGINAL_BILL_TEMPLATE;?>">Original (AB)</OPTION>
                    <OPTION VALUE="<?php echo CLASSIC_BILL_TEMPLATE;?>">Classic (AB bill Number Changes)</OPTION>
                    <OPTION VALUE="<?php echo CLASSIC_ADVANCE_BILL_TEMPLATE;?>">Classic Advance (ABC)</OPTION>
                    <OPTION VALUE="<?php echo MODERN_BILL_TEMPLATE;?>">Modern</OPTION>
                </select>
                </span>
            </td>
		</tr>
        ...
        <tr><td><br></td></tr>
		<tr>
        	<td valign="left"><span style="margin-left:4%;"><?php //echo $star;?>&nbsp;</span><span  style="margin-left: 3%;">Authorised Share Capital Text</span><span style="margin-left:22px;">&nbsp; : &nbsp;</span>
			<span style="margin-left:4%;"><input type="text" name="Authorised_Share_Capital_Text" id="Authorised_Share_Capital_Text" class="field_input" /></span></td>
		</tr>
         <tr>
        	<td valign="left"><span style="margin-left:4%;"><?php //echo $star;?>&nbsp;</span><span  style="margin-left: 3%;">Authorised Share Capital Amount</span><span style="margin-left:5px;">&nbsp; : &nbsp;</span>
			<span style="margin-left:4%;"><input type="text" name="Authorised_Share_Capital_Amount" id="Authorised_Share_Capital_Amount" class="field_input"/></span></td>
		</tr>
        <tr><td><br></td></tr>
		<tr>
        <td valign="left"><span style="margin-left: 4%;">&nbsp;</span><span  style="margin-left: 3%;">Show Outst. Amount on Maint. </span><span  style="margin-left: 0px;">&nbsp; : &nbsp;</span>
		<span  style="margin-left: 3%;"><input type="checkbox" name="apply_Outstanding_amount" id="apply_Outstanding_amount" value="1" style="    margin: 0px 0 0;"/></span></td>
    	</tr>

		<tr>
        <td valign="left"><span style="margin-left: 4%;">&nbsp;</span><span  style="margin-left: 3%;">(Supplementry, Invoice )</span>
        </tr>

...
$.ajax({
	...
	type : "POST",
	data: {"method":"IsvalidEntry","Id":iden[1]} ,
...
{	
	...
	if(arr1[0] == "edit")
	{
		...
		var optionEleObj = {'id':'PaidBy1'};
		PaidToChanged(optionEleObj,1);
		...
		if(arr2[0].ReconcileStatus == 1)
		{
			...
			{
				document.getElementById('TDS_Amount1').style.backgroundColor = 'lightgray';			
...
$.ajax({
	...
	{	
		...
		if(out != "")
		{
			//localStorage.setItem('refreshPage', "1"); // comment this line to prevent automatically refresh bannk statement
			window.close();				
		}
		else
		{

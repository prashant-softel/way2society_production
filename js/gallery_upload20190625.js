...
{
	var setcover = document.getElementsByClassName('setcover');
...
function DeleteAlbum(str)
{
	...
	var delete_album = document.getElementsByClassName('delete_album');
...
{ 
	var radioButton = document.getElementsByClassName('sendphoto');

function deletefile(id)
{
	...
	remoteCall("ajax/ajaxevents.php","form=events&method=delete1&eventsId="+id,"loadchanges1");
...
{	
	...
	{	//alert(arr2);
		console.log(arr2);
		document.getElementById("filenametd").style.display = "table-row";
		...
		if( arr2[10] != "")
		{
		document.getElementById("filename").innerHTML = "File Attached : " + arr2[10] + "<a  onClick='deletefile("+arr2[0]+")' style='color:#00F;padding-left:5px'><img src='images/del.gif' width='12' /></a>";
		}
		//alert(sample);
		/*var sample;

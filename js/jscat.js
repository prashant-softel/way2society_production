function getcat(str)
{
	...
	if(iden[0]=="delete")
	{
		...
		if(d==1)
		{
			remoteCall("ajax/ajaxcat.php","form=cat&method="+iden[0]+"&catId="+iden[1],"loadchanges");
		}
	}
	else
	{

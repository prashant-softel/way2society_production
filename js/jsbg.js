function getbg(str)
{
	...
	if(iden[0]=="delete")
	{
		...
		if(d==1)
		{
			remoteCall("ajax/ajaxbg.php","form=bg&method="+iden[0]+"&bgId="+iden[1],"loadchanges");
		}
	}
	else
	{

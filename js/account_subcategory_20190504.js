	...
	if(group_id==1 || group_id==2)
		 {
			...
			document.getElementById('opening_Balance_Label').innerHTML ='Opening Balance';
		 }
		 else
		 {
/*			 document.getElementById('opening').style.visibility = "hidden";
			 ...
			 document.getElementById('opening_Balance_Label').innerHTML ='Previous Year Balance';
...
function loadchanges()
{
	...
	{		
		...
		document.getElementById('srno').value=arr2[0].srno;	
		...
		if(date_diff > 1)
		{
			...
			document.getElementById('opening_type').disabled = true;
			document.getElementById('opening_type').style.backgroundColor = 'lightgray';	
		}

...
function loadchanges()
{
	...
	if(arr1[0] == "edit")
	{
		...
		document.getElementById('notify_payment_voucher_daily_by_email').checked = (arr2[62] == 1) ? true : false;
		document.getElementById('notify_payment_voucher_daily_by_sms').checked = (arr2[63] == 1) ? true : false;
